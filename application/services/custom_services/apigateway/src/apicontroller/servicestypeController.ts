...
export class servicestypeController implements Controller {
    ...
    private initializeRoutes() {
        this.router.delete('/servicestype/:id', this.GpDelete);
this.router.get('/servicestype/get/search', this.GpSearch);
this.router.put('/servicestype/get/update', this.GpSearchForUpdate);
this.router.put('/servicestype', this.GpUpdate);
this.router.get('/servicestype/:id', this.GpGetEntityById);
this.router.get('/servicestype', this.GpGetAllValues);
this.router.post('/servicestype', this.GpCreate);
this.router.get('/servicestype/userid/created_by', this.GpGetNounCreatedBy);
        //#@gepdelimeterone@#
        //#@ssofacebookapiroute@#
        //#@ssogithubapiroute@#
    }
